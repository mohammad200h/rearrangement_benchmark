...
def _make_block_model(name, width, height, depth, rgba=(1, 0, 0, 1), solimp=(0.95, 0.995, 0.001), solref=(0.002, 0.7)):
...
def _add_block(
    ...
    block = Block(name=name, width=width, height=height, depth=depth, rgba=rgba)
